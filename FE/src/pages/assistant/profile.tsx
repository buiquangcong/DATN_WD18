...
import { AssistantLayout } from "./layout/layout";
...
export default function ProfileAssistantPage() {
  ...
  useEffect(() => {
    ...
    const initialUser = {
      ...
      username: userObj?.displayName || userObj?.ten || userObj?.username || "Phụ xe NETBUS",
      email: userObj?.email || "phuxe@netbus.vn",
      ...
      role: userObj?.role || "assistant_driver",
      chucVu: userObj?.chucVu || "Phụ xe NETBUS",
    };
